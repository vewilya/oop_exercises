 ...
 * <p>It implements the Switchable interface and provides methods to switch the lights on and off as well as methods to check the current state of the lights. 
