...
/**
 * This class contains various methods for performing mathematical operations
 * and printing numbers and shapes.
 * The methods include finding the maximum and minimum values of integers,
 * finding the maximum value of three integers,
 * printing numbers using for, while, and do-while loops, adding a counter, and
 * printing a box shape.
